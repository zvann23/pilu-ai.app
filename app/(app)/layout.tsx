...
export default function ApplicationLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <BabyProfileProvider><ActivityProvider><DevelopmentProvider><CareProvider><AppShell>{children}</AppShell></CareProvider></DevelopmentProvider></ActivityProvider></BabyProfileProvider>;
}
